...
<article class="page-container">
	<form class="form form-horizontal" action="articleAddDo" method="post" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>描述：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="articletitle" name="con">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input style="width: 100%" type="number" class="input-text" placeholder="" id="articlesort" name="price">
			</div>
		</div>
		<div class="row cl">
